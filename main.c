...
void html_way_create(void){
	char path[256];
    sprintf(path,"%s/htmls/",now_pwd_dirrectory);
...
//INSERT IN BUFFER.txt
    char buffer_for_pwd[256];
    sprintf(buffer_for_pwd,"%s/buffer.txt", now_pwd_dirrectory);
    FILE *html_file = fopen(buffer_for_pwd,"a");
